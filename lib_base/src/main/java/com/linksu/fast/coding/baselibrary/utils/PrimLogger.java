...
public class PrimLogger {
    ...
    public static class Builder {
        ...
        public Builder setLogSwitch(boolean logSwitch) {
            PrimLogger.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setGlobalTag(String tag) {
            if (!isSpace(tag)) {
                PrimLogger.sGlobalTag = tag;
                sTagIsSpace = false;
            } else {
                PrimLogger.sGlobalTag = "";
                sTagIsSpace = true;
            }
            return this;
        }
